window.addEventListener('load', function () {
    ...
    class Player {
        ...
        update() {
            ...
            this.game.obstacles.forEach(obstacle => {
                ...
                //let collision = gam.checkCollieion(this, obstacle)[0]
    ...
    class Obstacle {
        ...
        draw(context) {
            ...
            if (this.game.debug) {
                context.beginPath()
                context.arc(this.collisionX, this.collisionY, this.collisionRadius, 0, Math.PI * 3)
                context.save()
                context.globalAlpha = 0.5;
                context.fill()
                context.restore()
    ...
    class Game {
        ...
        render(context, deltaTime) {
            ...
            if (this.score >= this.winningScore) {
                ...
                context.fillText("Final score " + this.score + ". Press 'R' to butt head again", this.width * 0.5, this.height * 0.5 + 80)
                context.restore()
            }
        }
        checkCollision(a, b) {
